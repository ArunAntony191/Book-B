...
try {
    ...
    header("Location: ../scripts/setup.php?error=database_not_setup");
    exit();
}
...
if (empty($credential)) {
    header("Location: ../pages/login.php?error=google_auth_failed");
    exit();
}
...
if ($user) {
    ...
    header("Location: ../pages/select_role.php");
}
exit();
?>
